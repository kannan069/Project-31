...
function preload(){
    strikeImg1 = loadImage('images/thunderbolt/1.png');
    strikeImg2 = loadImage('images/thunderbolt/2.png');
    strikeImg3 = loadImage('images/thunderbolt/3.png');
    strikeImg4 = loadImage('images/thunderbolt/4.png');
